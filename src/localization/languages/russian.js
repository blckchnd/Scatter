...
export default {
    [KEYS.GENERIC_New]:`Новый`,
    [KEYS.GENERIC_Save]:`Сохранить`,
    [KEYS.GENERIC_Ignored]:`Игнрируемый`,
    [KEYS.GENERIC_Identity]:`Личности`,
    [KEYS.GENERIC_Contract]:`Контракт`,
    [KEYS.GENERIC_Action]:`Действие`,
    [KEYS.GENERIC_Removed]:`Удаленный`,
    [KEYS.GENERIC_Name]:`Имя`,
    [KEYS.GENERIC_Search]:`Поиск`,
    [KEYS.GENERIC_VerifyPassword_Header]:`Проверьте Ваш Пароль`,
    [KEYS.GENERIC_VerifyPassword_Description]:`Вам нужно проверить Ваш текущий пароль прежде чем Вы сможете совершить это дейсвтие`,
    [KEYS.GENERIC_Host]:'Хост',
    [KEYS.GENERIC_Port]:'Порт',
    [KEYS.GENERIC_Requires]:'Requires',
    [KEYS.GENERIC_RequiredProperties]:'Обязательные Свойства',
    [KEYS.GENERIC_Import]:'Импортировать',
    [KEYS.GENERIC_ChainID]:'ID цепочки',
    [KEYS.GENERIC_Blockchain]:'Блокчейн',
    [KEYS.GENERIC_Account]:'Аккаунт',

    [KEYS.PLACEHOLDER_Name]:'Имя',
    [KEYS.PLACEHOLDER_PublicKey]:'Публичный ключ',
    [KEYS.PLACEHOLDER_PrivateKey]:'Приватный ключ',
    [KEYS.PLACEHOLDER_FirstName]:'Имя',
    [KEYS.PLACEHOLDER_LastName]:'Фамилия',
    [KEYS.PLACEHOLDER_Email]:'Почта',
    [KEYS.PLACEHOLDER_BirthDate]:'Дата Рождение',
    [KEYS.PLACEHOLDER_LocationName]:'Название Локации',
    [KEYS.PLACEHOLDER_DefaultLocationName]:'Домой',
    [KEYS.PLACEHOLDER_Phone]:'Телефон',
    [KEYS.PLACEHOLDER_Address]:'Адрес',
    [KEYS.PLACEHOLDER_City]:'Город',
    [KEYS.PLACEHOLDER_Postal]:'Индекс',
    [KEYS.PLACEHOLDER_Country]:'Страна',
    [KEYS.PLACEHOLDER_State]:'Штат',
    [KEYS.PLACEHOLDER_Password]:'Пароль',
    [KEYS.PLACEHOLDER_ConfirmPassword]:'Подтвердите Пароль',
    [KEYS.PLACEHOLDER_NewPassword]:'Новый Пароль',
    [KEYS.PLACEHOLDER_ConfirmNewPassword]:'Подтвердите Новый Пароль',
    [KEYS.PLACEHOLDER_DomainOrIP]:'Домен или IP',
